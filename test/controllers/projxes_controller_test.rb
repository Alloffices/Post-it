...
class ProjxesControllerTest < ActionController::TestCase
  ...
  test "should create projx" do
    assert_difference('Projx.count') do
      post :create, projx: { description: @projx.description, title: @projx.title, user_id: @projx.user_id }
    end
  ...
  test "should update projx" do
    patch :update, id: @projx, projx: { description: @projx.description, title: @projx.title, user_id: @projx.user_id }
    assert_redirected_to projx_path(assigns(:projx))
  end
